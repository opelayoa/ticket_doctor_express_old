 ...
 */
public class PossibleOriginAdapter extends ArrayAdapter<PossibleOrigin> {

    private final List<PossibleOrigin> ticketStatuses;
    private final Activity mContext;

    public PossibleOriginAdapter(Activity context, int resource, List<PossibleOrigin> ticketStatuses) {
