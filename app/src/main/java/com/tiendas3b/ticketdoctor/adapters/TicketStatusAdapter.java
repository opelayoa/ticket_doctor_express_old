 ...
 */
public class TicketStatusAdapter extends ArrayAdapter<TicketStatus> {

    private final List<TicketStatus> ticketStatuses;
    private final Activity mContext;

    public TicketStatusAdapter(Activity context, int resource, List<TicketStatus> ticketStatuses) {
