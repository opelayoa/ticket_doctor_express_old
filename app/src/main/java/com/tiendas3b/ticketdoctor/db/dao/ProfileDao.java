...
public class ProfileDao extends AbstractDao<Profile, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Hidden = new Property(3, Boolean.class, "hidden", false, "HIDDEN");
    };
    ...
    public Profile readEntity(Cursor cursor, int offset) {
        Profile entity = new Profile( //
            ...
            cursor.isNull(offset + 3) ? null : cursor.getShort(offset + 3) != 0 // hidden
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Profile entity, int offset) {
        ...
        entity.setHidden(cursor.isNull(offset + 3) ? null : cursor.getShort(offset + 3) != 0);
     }
